...
//check browser suppert location
...
//show error when location not supported
function showError(error){
  notificationElement.style.dsplay="block";
...
//chqnge when user clicks on temperature
